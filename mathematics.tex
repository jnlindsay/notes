...
\begin{shaded}
\textbf{Fourier series.} Consider a function $f : \mathbb{R} \to \mathbb{R}$ which is $2 \pi$-periodic and is square integrable (i.e., $\int_{-\pi}^\pi f(x)^2 \ dx < \infty $). Its Fourier series is given by
...
$$ a _k = \frac{\int_{-\pi}^\pi f(x) \cos(kx) \ dx}{\pi}, \quad k = 0, 1, 2, ... $$
and
$$ b _k = \frac{\int_{-\pi}^\pi f(x) \sin(kx) \ dx}{\pi}, \quad k = 1, 2, 3, ... $$
\end{shaded}