...
\begin{shaded}
\textbf{Definition (divergence) \cite{2111_notes}.} If $\mathbf{F} = F_1 \mathbf{i} F_2 \mathbf{j} F_2 \mathbf{k}$, the \textbf{divergence} of $\mathbf{F}$ is the scalar field
$$ \div \mathbf{F} = \nabla \cdot \mathbf{F} = \pdv{F_1}{x} \pdv{F_2}{y} \pdv{F_3}{z} . $$
\end{shaded}